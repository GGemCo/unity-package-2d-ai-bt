...
namespace GGemCo2DAiBtEditor
{
    ...
    internal static class BtNodeParentPolicy
    {
        ...
        public static bool SupportsMultipleParents(BtNodeRecord record)
        {
            ...
            return record.kind == BtNodeKind.Condition;
        }
        ...
        public static string GetMultipleParentsBlockedReason(BtNodeRecord record)
        {
            ...
            {
                BtNodeKind.Composite => "Composite nodes cannot have multiple parents yet.",
                BtNodeKind.Decorator => "Decorator nodes cannot have multiple parents yet.",
                BtNodeKind.Action => "Only Condition nodes support multiple parents right now.",
                _ => "This node does not support multiple parents."
            };
        }
    }
}
