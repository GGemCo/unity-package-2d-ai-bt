...
namespace GGemCo2DAiBtEditor
{
    ...
    /// </remarks>
    public class AddressableEditorAiBt : DefaultEditorWindow
    {
        ...
        /// </summary>
        [MenuItem(ConfigEditorAiBt.NameToolSettingAddressable, false, (int)ConfigEditorAiBt.ToolOrdering.SettingAddressable)]
        public static void ShowWindow()
        {
            GetWindow<AddressableEditorAiBt>(Title);
        }
